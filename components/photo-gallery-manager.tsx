...
const mockPhotos: Photo[] = [
  ...
  },
  {
    id: 4,
    url: "/placeholder.svg?height=300&width=400",
    caption: "Our food truck setup at the downtown location",
    category: "venue",
    featured: false,
      ...
      <Card>
        ...
        <CardContent>
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Add Photos to Your Gallery</h3>
            <p className="text-gray-600 mb-4">Upload high-quality photos of your fries to attract more customers</p>
            <Button className="bg-orange-500 hover:bg-orange-600 mb-2">
              <Upload className="w-4 h-4 mr-2" />
              Choose Files
            </Button>
            <p className="text-sm text-gray-500">Supported: JPG, PNG, WebP • Max size: 5MB • Recommended: 1200x800px</p>
          </div>
        </CardContent>
      </Card>
